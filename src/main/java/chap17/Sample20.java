...
public class Sample20 {
    public static void main(String[] args) {
        ...
        System.out.println(locals.stream().sorted().collect(Collectors.toList()));
        System.out.println(locals.stream().sorted(Collections.reverseOrder()).collect(Collectors.toList()));
